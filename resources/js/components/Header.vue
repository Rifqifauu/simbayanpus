...
<a v-if="user" href="/pesan" class="text-white text-lg hover:text-gray-200 transition px-3 py-2 relative group">
  ...
  <span class="absolute left-1/2 transform -translate-x-1/2 translate-y-6 opacity-0 group-hover:opacity-100 text-sm text-white bg-red-600 p-1 rounded transition-opacity z-10">Pesan</span>
</a>
            </div>
