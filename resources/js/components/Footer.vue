        ...
        <div class="flex justify-center md:justify-start mt-4 space-x-4">
           ...
           <a href="#" class="text-red-700 hover:text-red-500">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
              <path d="M24 4.557c-.883.392-1.83.656-2.828.775a4.933 4.933 0 002.165-2.724 9.862 9.862 0 01-3.127 1.197 4.924 4.924 0 00-8.388 4.482 13.978 13.978 0 01-10.148-5.15 4.916 4.916 0 001.524 6.573A4.903 4.903 0 01.96 9.374v.062a4.924 4.924 0 003.946 4.827 4.996 4.996 0 01-2.212.084 4.926 4.926 0 004.6 3.417 9.867 9.867 0 01-6.102 2.104c-.397 0-.788-.023-1.175-.069a13.945 13.945 0 007.557 2.212c9.054 0 14.001-7.496 14.001-13.986 0-.213-.005-.425-.014-.636A10.012 10.012 0 0024 4.557z" />
            </svg>
          </a>
          <!-- Facebook -->
          <a href="#" class="text-red-700 hover:text-red-500">
          ...
          <a href="#" class="text-red-700 hover:text-red-500">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
              <path d="M12 0C5.371 0 0 5.371 0 12s5.371 12 12 12 12-5.371 12-12S18.629 0 12 0zm5.539 7.385l-1.78 8.515c-.135.62-.493.773-1.004.481L11.5 13.04l-1.675 1.608c-.156.153-.288.283-.597.283l.21-2.947 5.361-4.826c.234-.204-.053-.318-.364-.114l-6.636 4.16-2.85-.892c-.621-.196-.634-.621.129-.918l11.14-4.312c.493-.192.922.115.753.92z" />
            </svg>
          </a>
          <!-- WhatsApp -->
          <a href="#" class="text-red-700 hover:text-red-500">
